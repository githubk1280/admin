		...
		<div id="page-wrapper" class="detailPage">
			<div class="row">
				<div class="col-lg-12">
					...
					<form:form action="updateFirst/${customer.customerId}" method="post" commandName="customer">
			...
			<div class="row row-margin">
				...
				<div class="col-md-4 col-sm-12 col-xs-12">
					...
					<div>
						<form:input id="resarchDirection" path="resarchDirection" type="text" class="form-control input-style" readonly="true" maxlength="10"/>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-4 col-sm-12 col-xs-12">
					...
					<div>
						<form:input id="relationShip" path="relationShip" type="text" class="form-control input-style" readonly="true" maxlength="10"/>
					</div>
				</div>
				<div class="col-md-4 col-sm-12 col-xs-12">
					<div>
					...
					<div>
						<form:input id="responsibleArea" path="responsibleArea" type="text" class="form-control input-style"   readonly="true"  maxlength="50"/>
					</div>
				</div>
			</div>
       </div>
