...
<nav
	...
	<div ng-controller="msgController">
		<ul class="nav navbar-top-links  navbar-right">
			<li id="createUserLi"><a
				href="<%=request.getContextPath()%>/user/add-redirect"> <i
					class="fa fa-sitemap fa-fw"></i>
			</a></li>
			<li id="messageLi"><a
				href="<%=request.getContextPath()%>/message/list?p=1"> <i
					class="fa fa-envelope fa-fw"></i><span id="messageBadge"
					class="badge message-badge-margin">{{msgNum}}</span>
			</a></li>
			<!-- /.dropdown -->
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					...
					<li id="modifyPasswordLi"><a
						href="<%=request.getContextPath()%>/user/modify-redirect"><i
	...
	<ul id="tabUl"
		...
		<li id="tab1"><a
			href="<%=request.getContextPath()%>/project/pages/1"><i
				class="fa fa-tasks fa-fw "></i><strong style="font-size: 17px">项目管理</strong></a></li>
		<li id="tab2"><a href="<%=request.getContextPath()%>/doc/load"><i
				class="fa fa-tasks fa-fw"></i><strong style="font-size: 17px">文档管理</strong></a></li>
		<li id="tab3"><a
			href="<%=request.getContextPath()%>/contract/pages/1"><i
				class="fa fa-tasks fa-fw"></i><strong style="font-size: 17px">财务管理</strong></a></li>
		<li id="tab4"><a
			href="<%=request.getContextPath()%>/sample/pages/1"><i
				class="fa fa-tasks fa-fw"></i><strong style="font-size: 17px">样品管理</strong></a></li>
		<li id="tab5"><a
			href="<%=request.getContextPath()%>/literature/list?pageIndex=1"><i
				class="fa fa-tasks fa-fw"></i><strong style="font-size: 17px">文献管理</strong></a></li>
	</ul>
	...
	<div class="navbar-default sidebar navbar-default-color "
		...
		<div class="sidebar-nav ">
			<ul class="nav" id="sidebarUl">
				<li style="display: none" id="projectBasicDataLi"><a
					id="link_pro" href="<%=request.getContextPath()%>/project/pages/1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">项目基本信息</strong></a></li>
				<li style="display: none" id="outsourceBasicDataLi"><a
					id="link_outsource"
					href="<%=request.getContextPath()%>/outsource/pages/1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">外包信息</strong></a></li>
				<li style="display: none" id="customerBasicDataLi"><a
					id="link_customer"
					href="<%=request.getContextPath()%>/customer/pages/1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">客户基本信息</strong></a></li>
				<li style="display: none" id="assignBasicDataLi"><a
					id="link_assgin"
					href="<%=request.getContextPath()%>/user/assign-redirect"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">分配项目</strong></a></li>
				<li style="display: none" id="docBasiceDataLi"><a id="link_doc"
					href="<%=request.getContextPath()%>/doc/load"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">文档基本信息</strong></a></li>
				<li style="display: none" id="contractBasicDataLi"><a
					id="link_contract"
					href="<%=request.getContextPath()%>/contract/pages/1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">财务合同基本信息</strong></a></li>
				<li style="display: none" id="sampleBasicDataLi"><a
					id="link_contract"
					href="<%=request.getContextPath()%>/sample/pages/1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">样品基本信息</strong></a></li>
				<li style="display: none" id="literatureBasicDataLi"><a
					id="link_literature"
					href="<%=request.getContextPath()%>/literature/list?pageIndex=1"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">文献基本信息</strong></a></li>
				<li style="display: none" id="sideModifyPasswordLi"><a
					id="link_sideModifyPassword"
					href="<%=request.getContextPath()%>/user/modify-redirect"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">修改密码</strong></a></li>
				<li style="display: none" id="sideCreateUserLi"><a
					id="link_sideCreateUser"
					href="<%=request.getContextPath()%>/user/add-redirect"><i
						class="fa fa-bar-chart-o fa-fw"></i> <strong
						style="font-size: 17px">创建新用户</strong></a></li>
...
<script type="text/javascript">
	window.onload = function() {
		...
		if (activeTabUrlStr.indexOf("user") > 0
				&& activeTabUrlStr.indexOf("modify") > 0) {
			$("#sideModifyPasswordLi").css('display', 'block');
			//sideModifyPassword
		}
		if (activeTabUrlStr.indexOf("user") > 0
				&& activeTabUrlStr.indexOf("add") > 0) {
